...
public class Load {
	...
	public void Loadfilter(String fileaddress,String filename) throws IOException{
		...
		PrintWriter outputWriter = new PrintWriter(fileaddress.substring(0, fileaddress.length()-4)+"_reformat.txt");
		 System.out.println(fileaddress.substring(0, fileaddress.length()-4)+"_reformat.txt");
