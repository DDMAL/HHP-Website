...
public class Filter {
	...
	public  void filterdata(String path) throws FileNotFoundException, UnsupportedEncodingException {
	    ...
	    System.out.println("output:"+path.substring(0,path.length()-4 )+"_processed.txt");
	    PrintWriter outputWriter = new PrintWriter(path.substring(0,path.length()-4 )+"_processed.txt","UTF-8");
